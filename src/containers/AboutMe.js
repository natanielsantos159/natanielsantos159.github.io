      ...
      <div className="info-wrapper">
        <div>
          ...
          <p className="about-me-home">
            ...
            estudando Desenvolvimento Web(Full Stack) na Trybe. Sempre fui apaixonado por
            tecnologia, já tenho um bom conhecimento em front-end e estou dando os meus primeiros
            passos em back-end!
          </p>
        </div>
